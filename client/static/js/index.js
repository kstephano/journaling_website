...
async function appendComments(id) {
    try {
        let res = await fetch(`${urlUsed}/search/${id}`, { headers: { 'Access-Control-Allow-Origin': "https://journaling-website.herokuapp.com" }})
    ...
    if (input) {
        ...
        const options = {
            ...
            headers: {
                ...
                'Access-Control-Allow-Origin': "https://journaling-website.herokuapp.com"
            }
        }
...
async function getPosts(e) {
    try{
        response = await fetch(`${urlUsed}/search/page/${pageNum}`, { headers: { 'Access-Control-Allow-Origin': "https://journaling-website.herokuapp.com" }});
...
async function unload(e) {    
    let options = {
        ...
        headers: { "Content-Type": "application/json", 'Access-Control-Allow-Origin': "https://journaling-website.herokuapp.com" }
    }
    try{
